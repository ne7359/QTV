...
```
wget https://github.com/MINGERTAI/QTV/raw/main/docker-zerotier-planet/docker-zerotier-planet.tar.gz && tar zxvf docker-zerotier-planet.tar.gz && chmod 777 docker-zerotier-planet && rm -f docker-zerotier-planet.tar.gz && cd docker-zerotier-planet && deploy.sh
```
