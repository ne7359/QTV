...
- [项目源码来自版本只支持1.10.2](https://github.com/xubiaolin/docker-zerotier-planet)
- [项目源码来自修改版支持与官方同步](https://github.com/wekingchen/docker-zerotier-planet/tree/master)
...
```
wget https://github.com/MINGERTAI/QTV/raw/main/docker-zerotier-planet/docker-zerotier-planet.zip && unzip docker-zerotier-planet.zip -d docker-zerotier-planet && chmod +x docker-zerotier-planet/deploy.sh && rm -f docker-zerotier-planet.zip && cd docker-zerotier-planet && ./deploy.sh
```
